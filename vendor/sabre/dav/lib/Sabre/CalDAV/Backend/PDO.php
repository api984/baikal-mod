...
class PDO extends AbstractBackend {
    ...
    public function getCalendarsForUser($principalUri) {
        ...
        $stmt = $this->pdo->prepare("SELECT " . $fields . " FROM ".$this->calendarTableName." WHERE principaluri = ? OR calendars.shared_to LIKE CONCAT('%', SUBSTRING_INDEX(? ,'/',-1), '%') OR shared_to LIKE '%all%' ORDER BY calendarorder ASC");
